...
export default function AdminProfile() {
  ...
  return (
    <div className="text-[#e7debb] font-montserrat px-4 md:px-0">
      ...
      <div className="bg-[#36573e] rounded-2xl py-10 px-6 md:px-12 border border-[#e7debb]/10 mb-8 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8 text-center sm:text-left">
            ...
            <label className="group relative w-32 h-32 md:w-36 md:h-36 bg-black rounded-full flex items-center justify-center overflow-hidden shadow-lg cursor-pointer border border-[#e7debb]/20 shrink-0">
              {previewImage ? (
            ...
            <div className="flex flex-col items-center sm:items-start">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif tracking-wide leading-tight">
                {profile?.first_name} {profile?.last_name}
              </h2>
              <span className="mt-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold bg-amber-500/10 text-amber-300 border border-amber-500/20 tracking-wider uppercase">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 border border-[#e7debb]/30 bg-[#27452f] text-[#e7debb] hover:bg-[#e7debb] hover:text-[#213a28] px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-200 shadow-md uppercase tracking-wider"
          >
            <LogOut size={15} />
            Sign Out
          </button>
      ...
      <div className="max-w-7xl mx-auto pb-10">
        <div className="rounded-2xl border border-[#e7debb]/10 bg-[#36573e]/40 p-6 md:p-8 shadow-sm">
          <h3 className="text-lg md:text-xl font-bold font-serif mb-6 tracking-wide border-b border-[#e7debb]/10 pb-3">
            Profile Details
          </h3>
          ...
          <form onSubmit={handleSubmit} className="grid gap-5 md:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-[#e7debb]/60 pl-1">First Name</label>
              <input 
                type="text" 
                name="first_name" 
                ...
                className="w-full rounded-xl bg-[#27452f] px-4 py-3 text-[#e7debb] outline-none border border-[#e7debb]/10 focus:ring-1 focus:ring-[#e7debb]/40 transition-all font-semibold text-sm md:text-base" 
              />
            </div>

            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-[#e7debb]/60 pl-1">Last Name</label>
              <input 
                type="text" 
                name="last_name" 
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-[#e7debb]/60 pl-1">Username</label>
              <input 
                type="text" 
                name="username" 
                value={form.username} 
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-[#e7debb]/60 pl-1">Email Address</label>
              <input 
                type="email" 
                name="email" 
                value={form.email} 
            ...
            <div className="md:col-span-2 pt-4 flex justify-center md:justify-start">
              <button 
                type="submit" 
                disabled={saving || uploading} 
                className="w-full md:w-auto rounded-full bg-[#27452f] hover:bg-[#1f3b26] border border-[#e7debb]/20 px-8 py-3.5 font-bold text-[#e7debb] transition-all disabled:opacity-70 tracking-wide text-sm shadow-md"
              >
